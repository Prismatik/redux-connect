...
var reduxAsyncReducer = (0, _reduxActions.handleActions)((_handleActions = {}, _handleActions[BEGIN_GLOBAL_LOAD] = function (state) {
...
var reducer = exports.reducer = function wrappedReducer(state, action) {
  // if state is undefined then it can't be converted to mutable
  var mutableState = state;
  if (mutableState !== undefined) {
    mutableState = (0, _state.getMutableState)(state);
  }
  return (0, _state.getImmutableState)(reduxAsyncReducer(mutableState, action));
};
